class UIComponents {
    static createActionGroup(currentStatus, onSeen, onRejected, onFavoriteClick) {
        ...
        const btnSeen = this.createBtn('seenit-btn-seen', 'Mark as Seen', `
            <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><polyline points="20 6 9 17 4 12"></polyline></svg>
        `, onSeen);

        const btnFavorite = this.createBtn('seenit-btn-fav', 'Add to Favorites', `
        ...
        const btnRejected = this.createBtn('seenit-btn-reject', 'Mark as Rejected', `
